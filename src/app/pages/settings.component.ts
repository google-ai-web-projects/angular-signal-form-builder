        ...
        <div class="max-w-4xl mx-auto space-y-6">
          ...
          <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                   ...
                   <input id="machineName" type="text" [(ngModel)]="config.global.formDefinition.name" (ngModelChange)="save()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all">
                </div>
                <div>
                   ...
                   <input id="displayName" type="text" [(ngModel)]="config.global.formDefinition.displayName" (ngModelChange)="save()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all">
                </div>
                <div class="md:col-span-2">
                   <label for="desc" class="block text-xs font-semibold text-gray-700 uppercase tracking-widest mb-1.5">Description</label>
                   <textarea id="desc" [(ngModel)]="config.global.formDefinition.description" (ngModelChange)="save()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all min-h-[80px]"></textarea>
                </div>
                <div>
                   <label for="version" class="block text-xs font-semibold text-gray-700 uppercase tracking-widest mb-1.5">Version</label>
                   <input id="version" type="text" [(ngModel)]="config.global.formDefinition.version" (ngModelChange)="save()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all">
                </div>
             </div>
          </div>
          ...
          <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
             ...
             <div class="flex gap-4">
                <label class="flex items-center gap-2 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors flex-1" [class.ring-2]="config.mode === 'editable'" [class.border-indigo-500]="config.mode === 'editable'" [class.bg-indigo-50]="config.mode === 'editable'">
                   <input type="radio" [(ngModel)]="config.mode" value="editable" (ngModelChange)="save()" class="text-indigo-600 focus:ring-indigo-500">
                ...
                <label class="flex items-center gap-2 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors flex-1" [class.ring-2]="config.mode === 'readOnly'" [class.border-indigo-500]="config.mode === 'readOnly'" [class.bg-indigo-50]="config.mode === 'readOnly'">
                   <input type="radio" [(ngModel)]="config.mode" value="readOnly" (ngModelChange)="save()" class="text-indigo-600 focus:ring-indigo-500">
                   <div class="flex flex-col">
                ...
                <label class="flex items-center gap-2 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors flex-1" [class.ring-2]="config.mode === 'disabled'" [class.border-indigo-500]="config.mode === 'disabled'" [class.bg-indigo-50]="config.mode === 'disabled'">
                   <input type="radio" [(ngModel)]="config.mode" value="disabled" (ngModelChange)="save()" class="text-indigo-600 focus:ring-indigo-500">
                   <div class="flex flex-col">
          ...
          <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
             <div class="flex items-center gap-2 mb-4 border-b border-gray-100 pb-3">
               <mat-icon class="text-indigo-600">cloud_download</mat-icon>
             ...
             <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input id="onInitHook" type="text" [(ngModel)]="config.lifecycle!.onInit" (ngModelChange)="save()" placeholder="FunctionName()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                  </div>
                  <div>
                    ...
                    <input id="beforeRenderHook" type="text" [(ngModel)]="config.lifecycle!.beforeRender" (ngModelChange)="save()" placeholder="FunctionName()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                  </div>
                  <div>
                    ...
                    <input id="afterRenderHook" type="text" [(ngModel)]="config.lifecycle!.afterRender" (ngModelChange)="save()" placeholder="FunctionName()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                  </div>
                </div>
             </div>
             ...
             <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                     ...
                     <select id="dsType" [(ngModel)]="config.dataSource.type" (ngModelChange)="save()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                  ...
                  <div>
                     ...
                     <input id="dsPath" type="text" [(ngModel)]="config.dataSource.config.path" (ngModelChange)="save()" placeholder="/metadata.json or https://..." class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                  </div>
                  <div>
                     ...
                     <select id="dsStrategy" [(ngModel)]="config.dataSource.config.loadingStrategy" (ngModelChange)="save()" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                  ...
                  <div class="flex items-center mt-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                       <input type="checkbox" [(ngModel)]="config.dataSource.config.disableUntilHydrated" (ngModelChange)="save()" class="text-indigo-600 rounded focus:ring-indigo-500">
             ...
             <div>
                ...
                <div class="flex items-center gap-6 mb-4">
                  <label class="flex items-center gap-2 cursor-pointer">
                     <input type="checkbox" [(ngModel)]="config.dataSource.mapping.autoMap" (ngModelChange)="save()" class="text-indigo-600 rounded focus:ring-indigo-500">
                     <span class="text-sm font-medium text-gray-700">Auto-map matching keys</span>
                  </label>
                  <label class="flex items-center gap-2 cursor-pointer">
                     <input type="checkbox" [(ngModel)]="config.dataSource.mapping.strict" (ngModelChange)="save()" class="text-indigo-600 rounded focus:ring-indigo-500">
          ...
          <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
             ...
             <label class="flex items-center gap-2 cursor-pointer mb-4">
                <input type="checkbox" [(ngModel)]="config.observability.valueChanges.enabled" (ngModelChange)="save()" class="text-indigo-600 rounded focus:ring-indigo-500">
             ...
             @if(config.observability.valueChanges.enabled) {
                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 grid grid-cols-1 md:grid-cols-2 gap-4">
                   <div>
                      ...
                      <select id="emitOn" [(ngModel)]="config.observability.valueChanges.emitOn" (ngModelChange)="save()" class="w-full text-sm px-3 py-2 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none">
          ...
          <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                   ...
                   <input id="defaultLang" type="text" [(ngModel)]="config.global.i18n.defaultLanguage" (ngModelChange)="save()" placeholder="en" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all">
                </div>
                <div>
                   ...
                   <input id="supportedLangs" type="text" [ngModel]="getLanguagesString()" (ngModelChange)="updateLanguages($event)" placeholder="en: English, ar: Arabic" class="w-full text-sm px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all">
                </div>
                <div class="md:col-span-2">
                   ...
                   <textarea id="translationKeyMapping" [ngModel]="getTranslationKeyMappingJson()" (ngModelChange)="updateTranslationKeyMapping($event)" placeholder='{ "en": "/assets/i18n/en.json", "zh": "/assets/i18n/zh.json" }' class="w-full text-sm font-mono px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all min-h-[40px]"></textarea>
                </div>
             ...
             <div class="bg-gray-50 p-4 border border-gray-200 rounded-lg">
                ...
                <div class="flex gap-4">
                   <label class="flex items-center gap-2 cursor-pointer">
                      <input type="radio" [(ngModel)]="config.global.i18n.httpStatusMappings.sourceResolution" value="globalStatus" (ngModelChange)="save()" class="text-indigo-600">
                      <span class="text-sm text-gray-700">Native HTTP Status (globalStatus)</span>
                   </label>
                   <label class="flex items-center gap-2 cursor-pointer">
                      <input type="radio" [(ngModel)]="config.global.i18n.httpStatusMappings.sourceResolution" value="responseBodyKey" (ngModelChange)="save()" class="text-indigo-600">
                      <span class="text-sm text-gray-700">JSON Body Key (responseBodyKey)</span>
                   </label>
                   <label class="flex items-center gap-2 cursor-pointer">
                      <input type="radio" [(ngModel)]="config.global.i18n.httpStatusMappings.sourceResolution" value="header" (ngModelChange)="save()" class="text-indigo-600">
